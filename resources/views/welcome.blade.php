...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <h3>Aulão de <strong> Front</strong></h3>
      <h1> Adapti</h1>
      <h2>A EJ mais AMADAH do Brasil</h2>
      <a href="#about" class="btn-get-started scrollto">Bora lá</a>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Serviços</h2>
          <h3>Saiba mais sobre nossos <span>Serviços</span></h3>
          <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque vitae autem.</p>
        </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              UFES<br>
              São Mateus <br><br>
              <strong>Numero:</strong>27 99999 9999<br>
              <strong>E-mail:</strong> info@adapti.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Adapti</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">Adapti</a>
        </div>
      </div>
